...
export default async function AdminDashboard() {
  const [events, episodes, posts, chapters, observatory, donations, sponsorships, members] =
    await Promise.all([
      prisma.event.count(),
  ...
  const cards: Array<[string, number, string]> = [
    ...
    ["Episodios", episodes, "/admin/podcast"],
    ["Publicaciones", posts, "/admin/posts"],
    ["Capítulos", chapters, "/admin/chapters"],
    ["Observatorio", observatory, "/admin/observatory"],
    ["Donaciones", donations, "/admin/donations"],
    ["Apadrinamientos", sponsorships, "/admin/sponsorships"],
  ...
  return (
    <div>
      ...
      <p className="mt-1 text-muted">Gestioná el contenido de la comunidad y los capítulos.</p>
